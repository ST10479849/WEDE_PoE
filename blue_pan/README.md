...
The goals that I have for this website would be for my aunt to have increased clientele and sell her products and services. To increase recognition and engagement provide customers with needed information, rather than customers seeking for answers from the owner when they can just find what they are looking for on the website. Create a strong online presence that communicates the bakery’s identity, values, and unique selling points this will enhance brand visibility. To increase customer engagement, we’ll provide a user-friendly and interactive platform that allows customers to connect with the brand beyond in-store visits. Attract new customers beyond the bakery’s physical location, including event catering clients this ties in with increasing clientele. To improve service efficiency, use the website as a tool to streamline orders, bookings, and customer inquiries. Leverage digital marketing opportunities to boost sales and grow the customer base. The objectives would be uploading and maintain a digital menu with clear descriptions, prices, and high-quality images of bakery items and catering packages. Adding a booking form with a date, event details, and specifications on the catering/baked goods. Optimize the site for smartphones and tablets to improve accessibility and customer convenience. Link the website to Instagram, Facebook, and TikTok, while using SEO and Google Analytics to drive traffic and track performance. A live chat, chatbot, or easy-to-find contact form for quick responses to inquiries and complaints.

###### Features and functionality
I am proposing the following features for the website an about us page, contact us page and homepage the product and services page will be part of the functionality of the website where users will be able to scroll through the images similarly to how one does on the phone in the gallery/photos app the website will have videos as well. Images and videos of the bakers at work how the setting up of the platters go the decorating of the cake etc. The final functionality would be a search bar. .  For the home page we’ll have navigation logo and slogan. For the about us page we’ll have navigation background/description of business and picture of founder who is also the baker and manager. For the product and services page we’ll have navigation the products offered, their prices and images, we’ll have the service offered and images of that. The gallery page will have all images of our products and services.
...
DRP Collection,2025.BEST ballon decoration ideas for birthday parties at home.[video online]Avaliable at: <https://youtu.be/F4KPKS_SKjg?si=J4wVscIKhV6edbUO>

I heart naptime,2018.Cheese platter.[online] Availble: <https://share.google/images/ipRuNu4jPI108fCmR> [Accessed 14 Nov 2018]

Galore of flavors,2019.Party appetizer buffet table.[online].2019. Availble: <https://youtu.be/PAk0O8PNTXk?si=h3-_0HYxkInYKv0A>

Mouni's kitchen,2022.cakes in 2 mintues! you will make this cake everyday! easy and quick to prepare.[video online] Available at: <https://youtu.be/vKTBBc13o88?si=97NRr36MffyiQhmQ>

Plowing through life,2022.Veggie platter.[online] Availbel at: <https://share.google/images/kRxpn99kJhLgFI08d> [Accessed 11 
Nov 2022]

Pintrest,2023.Meat platter. [online] Avaible at: <https://share.google/images/JHSVqLm9bVGsspBAl> [Accessed 6 Nov 2023]

Veggie desserts,2023.fruit platter. [online] Avaible at: <https://share.google/images/C8mbMa2EnLQhiTsTo> [Accessed 23 July 2023]
...
##### Part 2 Details 
For part 2 of the PoE i added Css code to make my website aesthically pleasing adding colour font and decoration and also making it responsive. 
